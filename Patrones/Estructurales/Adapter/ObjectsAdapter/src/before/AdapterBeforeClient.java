...
class LegacyLine {
	// to draw a line we need the coordinates of two extreme points
...
class LegacyRectangle {
	// to draw a rectangle we need the coordinates of its top left corner, the width
	// and the height
...
public class AdapterBeforeClient {
	public static void main() {
		...
		for (int i = 0; i < shapes.length; ++i)
			// we need to identify the type of figure in order to call the appropriate
